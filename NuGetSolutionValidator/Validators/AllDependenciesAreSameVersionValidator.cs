...
{
    public class AllDependenciesAreSameVersionValidator:IValidator<Solution>
    {
        public IEnumerable<ValidationResult> Validate(Solution toValidate)
        {
            var packagesById = toValidate.Projects
